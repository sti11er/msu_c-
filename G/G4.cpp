...
BoundedStack::BoundedStack(const BoundedStack& other) {
    ...
    // stack = new Data*[tmp.max_size];
    // for (size_t i=0; i<tmp.curr_size; ++i) {
    //     stack[i] = tmp.stack[i];
    // }
    // curr_size = tmp.curr_size;
...
BoundedStack& BoundedStack::operator= (const BoundedStack& other) {
    ...
    // Data** tmp = new Data*[other.max_size];
    // for (size_t i = 0; i < other.curr_size; ++i) {
    //     tmp[i] = (other.stack[i])->clone();
    // }
...
// main() 
// {
//     BoundedStack stack(10);
//     Number A(100);
//     stack.push(A);
//     stack.push(Text("odsf"));
//     stack.push(Number(40));

//     BoundedStack stack2(stack);
//     stack2.push(A);
//     stack2.push(Number(15));
    
//     // stack = stack2;
    
//     std::cout << dynamic_cast <Number *> (stack2.pop())->value() << '\n';
//     std::cout << dynamic_cast <Number *> (stack2.pop())->value() << '\n';
// }
